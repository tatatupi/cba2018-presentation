...
\setbeamertemplate{footline}{}
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{template/inicio.png}}%
...
\begin{frame}
	...
	\begin{figure}
		...
		\includegraphics[width=0.75\textwidth]{images/pdf-propagacao2.jpg}
	\end{figure}
...
\begin{frame}
	...
	\begin{figure}
		...
		\begin{adjustbox}{width=\textwidth/2,height=0.8\textheight,keepaspectratio}
			...
			\node (pro12) [process, below of=pro1][text width=3cm,align=center, yshift=0.5cm]{Etapa de Predição, utilizando ZOH};
...
{
\setbeamertemplate{footline}{}
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{template/fim.png}}%
\begin{frame}[plain]
\centering
\Large
\textbf{Obrigado!}
